...
const EN_MESSAGES = {
  ...
  'voice.gameplay': 'Watch the display. You will have ten seconds to say an answer for each of eight questions.',
  ...
  'voice.answerResume': 'Answer now. You have {seconds} seconds remaining.',
  ...
  'voice.result': '{name}, your score is {score}. You answered {correct} of eight correctly.',
...
const PT_MESSAGES: Record<TriviaMessageKey, string> = {
  ...
  'voice.gameplay': 'Olhe para a tela. Você terá dez segundos para dizer uma resposta em cada uma das oito perguntas.',
  ...
  'voice.answerResume': 'Responda agora. Você tem {seconds} segundos restantes.',
  ...
  'voice.result': '{name}, sua pontuação é {score}. Você acertou {correct} de oito perguntas.',
